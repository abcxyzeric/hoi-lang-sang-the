...
#mobile-phone-overlay .mobile-phone-screen {
    ...
    background-image: url('https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/cover/phap-lo-dac.webp') !important;
...
const CHARACTER_AVATAR_CONFIG = {
    'Naiyali': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/nai-nha-le.webp',
    'Astesia': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/tinh-cuc.webp',
    'Forte': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/phap-lo-dac.webp',
    'Asuna': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/asuna.webp',
    'Ruruka': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/ruruka.webp',
    'Orchis': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/orchis.webp',
    'Scarlet': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/hong-lien.webp',
    'Ecclesia': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/aiklisia.webp',
    'Kurami': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/kurami.webp',
    'Hatsuse Izuna': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/hatsuse-izuna.webp',
    'Stephanie': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/stephanie.webp',
    'Jibril': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/jibril.webp',
    'Tetto': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/tetto.webp',
    'Shiro': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/shiro.webp',
    'Hiiro': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/hiiro.webp',
    'Feel': 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/feel.webp',
    "Cartethyia": 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/katisia.webp',
    "Aemeath": 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/amis.webp',
    "Lumioer": 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/lumioer.webp',
    "Argent": 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/head/argent.webp'
};
...
Object.assign(CHARACTER_AVATAR_CONFIG, {
    ...
    '\u7490\u7c73\u6b27\u513f': CHARACTER_AVATAR_CONFIG['Lumioer'],
    '\u96c5\u513f\u8d1e\u7279': CHARACTER_AVATAR_CONFIG['Argent'],
...
// Dữ liệu hình nền.
const phoneWpBaseUrl = 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/cover/';
const phoneWpData = {
    'Cartethyia': ['\u5361\u63d0\u5e0c\u5a05'],
    'Naiyali': ['\u5948\u96c5\u4e3d'],
    'Astesia': ['\u661f\u6781'],
...
function extractMvuGameData(mvuData) {
    ...
    if (statData && typeof statData === 'object' && Object.keys(statData).length > 0) {
        return window.HLSTKeyAdapter ? window.HLSTKeyAdapter.toInternal(statData) : statData;
    }
    ...
    if (dataKeys.length > 0) {
        return window.HLSTKeyAdapter ? window.HLSTKeyAdapter.toInternal(mvuData) : mvuData;
    }
...
function restoreWallpaper() {
    try {
        const defaultWallpaper = 'https://cdn.jsdelivr.net/gh/abcxyzeric/hoi-lang-sang-the@v20260609-live-mod-update-5/assets/avatars/cover/phap-lo-dac.webp';
...
// ==================== APP Sổ thế giới ====================
// Đồng bộ theo cơ chế 4.0: bật entry thuộc thế giới quan đang chọn, tắt entry của các thế giới quan khác.
const PHONE_WORLDVIEWS = [
    { id: 'corridor', label: 'Hành Lang Sáng Thế', icon: 'fa-dice', open: ['Hành Lang Sáng Thế', 'DNF', 'NGNL'], close: ['SAO', 'Hổ Phách', 'Đại Minh'] },
    { id: 'sao', label: 'Sword Art Online', icon: 'fa-gamepad', open: ['Hành Lang Sáng Thế', 'SAO'], close: ['Hổ Phách', 'DNF', 'NGNL', 'Đại Minh'] },
    { id: 'amber', label: 'Kiếm Hổ Phách', icon: 'fa-chess-rook', open: ['Hổ Phách'], close: ['Hành Lang Sáng Thế', 'SAO', 'DNF', 'NGNL', 'Đại Minh'] },
    { id: 'daming', label: 'Đại Minh chí dị', icon: 'fa-dragon', open: ['Đại Minh'], close: ['Hành Lang Sáng Thế', 'SAO', 'Hổ Phách', 'DNF', 'NGNL'] }
];
...
async function phoneSetWorldviewVariable(label) {
    ...
    try {
        ...
        const workingStatData = keyAdapter ? keyAdapter.toInternal(mvuData.stat_data) : mvuData.stat_data;
        if (!workingStatData.Cấu_hình_hệ_thống) {
            workingStatData.Cấu_hình_hệ_thống = {};
        }
        workingStatData.Cấu_hình_hệ_thống.Thế_giới_quan = label;
        mvuData.stat_data = keyAdapter ? keyAdapter.toCanonical(workingStatData) : workingStatData;
        await mvu.replaceMvuData(mvuData, { type: 'message', message_id: 'latest' });
        return true;
    } catch (e) {
        console.error('[Sổ thế giới] Ghi biến thế giới quan thất bại:', e);
        return false;
    }
}
...
function generateWorldbookPanel() {
    ...
    return `
        ...
        <div class="settings-section">
            <div class="settings-section-title">Chuyển nhanh thế giới quan</div>
...
async function phoneLoadWorldbookStatus() {
    ...
    const config = data.Cấu_hình_hệ_thống || data['\u7cfb\u7edf\u914d\u7f6e'] || {};
    const currentLabel = config.Thế_giới_quan || config['\u4e16\u754c\u89c2'] || 'Chưa đặt';
    ...
    $('#wb-current-view').html(`
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <div>
                ...
                <div style="font-size:12px;color:#9ca3af;">Cấu_hình_hệ_thống · Thế_giới_quan</div>
            </div>
        </div>
    `);
...
async function phoneSwitchWorldview(targetId) {
    ...
    if (!view) return;
    if (!confirm(`Chuyển sang "${view.label}"?\nSổ thế giới thuộc nhánh này sẽ được bật, các nhánh khác sẽ tắt, và biến thế giới quan sẽ được đặt thành "${view.label}".`)) return;

    const TH = phoneGetTavernHelper();
    if (!TH || typeof TH.getWorldbook !== 'function' || typeof TH.replaceWorldbook !== 'function') {
        if (typeof toastr !== 'undefined') toastr.error('Không dùng được API worldbook của TavernHelper');
        return;
    }
    ...
    try {
        ...
        for (const wb of names) {
            ...
            const updated = entries.map(entry => {
                const entryName = String((entry && (entry.name || entry.comment || entry.uid)) || '');
                const hasOpen = view.open.some(t => entryName.includes(t));
                const hasClose = view.close.some(t => entryName.includes(t));
                if (hasOpen || hasClose) {
                    const targetState = hasClose ? false : true;
                    if (entry.enabled !== targetState) {
                        wbChanged = true;
                        changedEntries++;
                        return { ...entry, enabled: targetState };
                    }
                }
                return entry;
            });
        ...
        if (typeof toastr !== 'undefined') {
            toastr.success(`Đã chuyển sang "${view.label}": cập nhật ${changedBooks} sổ / ${changedEntries} entry${varOk ? '' : ' (ghi biến thế giới quan thất bại)'}`);
        }
        if (typeof fetchLatestMvuData === 'function') fetchLatestMvuData(true);
        phoneLoadWorldbookStatus();
    } catch (e) {
        console.error('[Sổ thế giới] Chuyển thất bại:', e);
        if (typeof toastr !== 'undefined') toastr.error('Chuyển thất bại: ' + (e.message || e));
    }
};
