...
async function phoneSetWorldviewVariable(label) {
    ...
    try {
        ...
        if (!mvuData.stat_data.Cấu_hình_hệ_thống) {
            mvuData.stat_data.Cấu_hình_hệ_thống = mvuData.stat_data['\u7cfb\u7edf\u914d\u7f6e'] || {};
        }
        mvuData.stat_data.Cấu_hình_hệ_thống.Thế_giới_quan = label;
